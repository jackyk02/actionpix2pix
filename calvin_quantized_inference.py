...
from bitsandbytes import load_and_optimize_bnb_8bit
...
def load_or_create_unet():
    ...
    return load_and_optimize_bnb_8bit(UNet2DConditionModel.from_pretrained(
...
def load_models():
    ...
    vae = load_and_optimize_bnb_8bit(AutoencoderKL.from_pretrained(
        "runwayml/stable-diffusion-v1-5", subfolder="vae", torch_dtype=torch.float16))
    text_encoder = load_and_optimize_bnb_8bit(CLIPTextModel.from_pretrained(
